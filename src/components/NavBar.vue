<template>
  <div
    class="fixed top-0 left-0 right-0 bg-teal-500 text-coolGray-300 py-6 z-10"
  >
    <div class="container mx-auto flex justify-between items-center">
      <div class="brand flex space-x-2 text-3xl">
        <mdi:message-processing-outline class="text-blue-800" />
        <h1 class="font-thin text-blue-800">
          Chit<span class="font-bold text-blue-800">Chat</span>
        </h1>
      </div>
      <div class="menu">
